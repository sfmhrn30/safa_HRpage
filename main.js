    ...
    <div class="employee-card" id="employee-1">
      ...
      <span>
        <div class="employement-details" id="employee1-details">
          <span style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif" class="name-format">`+name+`</span>
          <span style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif" class="name-format">`+surname+`</span>
          <br>
          <span>`+position+`</span>
          <br>
...
function addInterview(){
 ...
 <li>
   <div class="list-item">
     <h3 style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">`+positionInterview+`</h3>
